package com.example.movieskotlin.data.repository
...
class MovieDetailsNetworkDataSource(private val apiService: TheMovieDBInterface, private val compositeDisposable: CompositeDisposable) {
    ...
    private val _downloadedMovieDetailsResponse = MutableLiveData<MoviesDetail>()
    val downloadedMovieResponse: LiveData<MoviesDetail>
